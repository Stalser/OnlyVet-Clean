        ...
        <div className="rounded-3xl border border-slate-200 bg-white shadow-sm px-6 py-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={pending}
              className="w-full rounded-xl bg-slate-900 text-white text-sm font-medium py-2.5 mt-1 disabled:opacity-60"
            >
          ...
          <div className="mt-4 flex items-center justify-between text-[11px] text-gray-500">
            <button
              ...
              onClick={() => alert("Фlow восстановления пароля настроим позже.")}
            >
              Забыли пароль?
            </button>
            <span>
              ...
              <span className="text-gray-800">
                Регистрация по запросу в клинику
              </span>
            </span>
          </div>
        </div>

        {/* Низ страницы с дисклеймером */}
